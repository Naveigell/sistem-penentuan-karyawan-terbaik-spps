...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="@if (request()->routeIs('admin.criteria.*')) active @endif"><a class="nav-link" href="{{ route('admin.criteria.index') }}"><i class="fas fa-flag"></i> <span>Kriteria</span></a></li>
