...
use App\Utils\DecisionSupportSystem\Copeland;
use Illuminate\Http\Request;

class CopelandController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $copeland = new Copeland($employeeData, $criteriaData);
        $copeland->calculate();

        $results = $copeland->results();

        return view('admin.pages.decision_support_system.copeland.index', compact('results', 'criteria', 'employees'));
    }
